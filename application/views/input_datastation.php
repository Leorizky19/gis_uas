            ...
            <div class="form-body">
              <div class="row">
                ...
                <div class="col-md-8 form-group">
                  <input type="text" value="<?= set_value('nama_station') ?>" required class="form-control"
...
if (curLocation[0] == 0 && curLocation[1] == 0) {
  curLocation = [-6.902985, 107.618786];
}

var mymap = L.map('mapid').setView([-6.902985, 107.618786], 9);
